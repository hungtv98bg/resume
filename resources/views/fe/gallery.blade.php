        ...
        <div class="container-fluid">
            <div class="single-head">
                <div class="col">
                    ...
                    <h3>Beautifull Gallery Of Vietnam</h3>
                    <p>Capture beautiful moments with instagramable nuances in Vỉetnam. Here are portraits captured by tourists</p>
                </div>
            </div>
        </div>
        <div class="row">
