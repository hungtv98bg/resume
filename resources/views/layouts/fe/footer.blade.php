    ...
    <section class="section-footer">
        ...
        <div class="row">
            <div class="col-left">
                ...
                <p>Hung Developer <br>
                    Phone : +84 367832744 <br>
                    Email : tahung98svtybg@gmail.com </p>
                <a href="https://www.facebook.com/hung.ta.9822/" target="_blank"><span
                        class="ion-social-facebook icon-social"></span></a>
                <a href="https://www.instagram.com/hung.tryndamare/?hl=en" target="_blank"><span
                        class="ion-social-instagram icon-social"></span></a>
                <a href="https://twitter.com/hungtv98" target="_blank"><span
        ...
        <div class="footer-bottom">
            <p><a href="https://github.com/" rel="noreferer" target="_blank">{{ config('app.name2', 'Việt nam đó đây') }}</a> - Created With <span class="ion-heart red"></span> to create a Lovable Website</p>
        </div>
    </section>
