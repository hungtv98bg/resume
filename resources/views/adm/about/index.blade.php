...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            @csrf
                <div class="card-header">
                    <h3 class="card-title">Diện tích</h3>
        ...
        <div class="col-12">
            ...
            @csrf
                <div class="card-header">
                    <h3 class="card-title">Tài nguyên thiên nhiên</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                            <i class="fas fa-plus"></i>
                        </button>
        ...
        <div class="col-12">
            ...
            @csrf
                <div class="card-header">
                    <h3 class="card-title">Phong tục tập quán</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                            <i class="fas fa-plus"></i>
                        </button>
        ...
        <div class="col-12">
            ...
            @csrf
                <div class="card-header">
                    <h3 class="card-title">Trang phục
                    </h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                            <i class="fas fa-plus"></i>
